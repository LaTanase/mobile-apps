...
import com.example.lab8ex2.adapter.EventRecyclerViewAdapter;
import com.example.lab8ex2.database.SqliteDBHelper;
...
public class MainActivity extends AppCompatActivity implements EventRecyclerViewAdapter.ItemClickListener{
    ...
    protected void onResume() {
        if (totalEvents != sqliteDBHelper.getAllEvents().size()){
            //update events home
            events.clear();
            loadEvents();
        }
